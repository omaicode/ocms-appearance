<div class="card">
    <div class="card-header">
        <h5 class="card-title mb-0">@lang('appearance::messages.theme_options')</h5>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-12 col-xl-2 col-lg-3">
                <ul class="nav nav-pills flex-column">
                    <li class="nav-item mb-2 pe-0">
                        ...
                        >
                            @lang('appearance::messages.general')
                        </a>
                    </li>
                    <li class="nav-item mb-2 pe-0">
                        <a 
                    ...
                    <li class="nav-item pe-0">
                        ...
                        >
                            @lang('appearance::messages.images')
                        </a>
                    </li>
                </ul>
            </div>
            <div class="col-12 col-xl-10 col-lg-9">
                ...
                <button type="submit" class="btn btn-success text-white">
                    ...
                    @lang('appearance::messages.form.save_options')
                </button>
                </form>
            </div>
        </div>
